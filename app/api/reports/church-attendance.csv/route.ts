...
export async function GET(request: Request) {
  ...
  let query = supabase
    ...
    .select("adult_male_count, adult_female_count, children_count, new_members_male_count, new_members_female_count, new_converts_male_count, new_converts_female_count, total_count, updated_at, services!inner(service_date, service_type)")
