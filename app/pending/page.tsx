    ...
    <main className="flex min-h-screen items-center justify-center bg-[#eef3ff] px-5 py-8 sm:py-12">
      <section className="w-full max-w-xl rounded-[2rem] border border-white bg-white p-6 text-center shadow-[0_24px_70px_rgba(41,61,112,0.14)] sm:p-12">
        ...
        <form action={signOut} className="mt-7">
          <FormSubmitButton pendingLabel="Signing out..." className="min-h-12 w-full rounded-xl border border-[#d8e0f0] px-6 text-sm font-semibold text-[#34415f] transition hover:bg-[#f5f7fc] disabled:opacity-60 sm:w-auto">Sign out</FormSubmitButton>
        </form>
      </section>
    </main>
  );
