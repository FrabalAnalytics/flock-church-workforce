...
test("backup manifest includes identity, people, attendance, care, and audit data", () => {
  for (const table of ["church_settings", "profiles", "workers", "attendance_logs", "followup_events", "first_timers", "first_timer_interactions", "first_timer_visits", "first_timer_stage_history", "audit_events"]) {
