  ...
  return (
    <div className="mx-auto max-w-4xl">
      ...
      <form action={action} className="mt-8 grid gap-5 rounded-3xl border border-[var(--color-border)] bg-white p-5 shadow-[var(--shadow-sm)] sm:grid-cols-2 sm:p-8">
        ...
        <label className="text-sm font-semibold text-[var(--color-text-secondary)]">Phone number<input className="mt-2 h-12 w-full rounded-xl border border-[var(--color-border)] px-4 text-sm font-normal outline-none focus:border-[var(--color-primary)]" name="phone_number" type="tel" inputMode="tel" defaultValue={worker?.phone_number ?? ""} /></label>
